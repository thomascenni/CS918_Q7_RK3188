...
RK_S32 JPEG_EncAsicMemAlloc_V2(asicData_s * asic, RK_U32 width, RK_U32 height,
                       RK_U32 encodingType);
void JPEG_EncAsicMemFree_V2(asicData_s * asic);
...
RK_S32 JPEG_EncAsicCheckStatus_V2(asicData_s * asic);
...
RK_S32 JPEG_EncAsicCheckStatus(asicData_s * asic);
