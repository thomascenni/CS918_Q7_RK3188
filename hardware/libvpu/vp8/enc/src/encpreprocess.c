...
------------------------------------------------------------------------------*/
i32 VP8_EncPreProcessCheck(const preProcess_s * preProcess)
{
    i32 status = ENCHW_OK;
    u32 tmp;
    u32 width, height;
...
------------------------------------------------------------------------------*/
void VP8_EncPreProcess(asicData_s * asic, const preProcess_s * preProcess)
{
    u32 tmp;
    u32 width, height;
    regValues_s *regs;
...
------------------------------------------------------------------------------*/
void VP8_EncSetColorConversion(preProcess_s * preProcess, asicData_s * asic)
{
    regValues_s *regs;
