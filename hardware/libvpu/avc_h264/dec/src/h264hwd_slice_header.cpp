...
u32 RefPicListReordering(strmData_t *, refPicListReordering_t *,
                                u32, u32, u32);

u32 PredWeightTable(strmData_t *, sliceHeader_t *, u32 monoChrome);

u32 NumSliceGroupChangeCycleBits(u32 picSizeInMbs,
